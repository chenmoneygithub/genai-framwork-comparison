...
def run_agent_with_intermediate_streaming(user_request: str):
...
def run_agent_with_token_streaming(user_request: str):
...
run_agent("Please help me book a flight from SFO to JFK on 09/01/2025, my name is Chelsie")
run_agent_with_intermediate_streaming("Please help me book a flight from SFO to JFK on 09/01/2025, my name is Adam")
run_agent_with_token_streaming("Please help me book a flight from SFO to SNA on 10/01/2025, my name is Adam")
